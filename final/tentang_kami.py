...
def tentang_kami():
    ...
    **Misi**:
    ...
    with col2:
        st.image("images/azizz.jpeg", caption="Abdul Aziz", width=150)
        st.write("Anggota - 0110124095")
    with col3:
        st.image("images/andree.jpeg", caption="Andre Ghailan Pratama", width=150)
        st.write("Ketua - 0110124136")
    with col4:
        st.image("images/ridho.jpeg", caption="Abdul Aziz", width=150)
        st.write("Anggota - 0110124095")
